...
/**
 * The Altimea Custom Messages Loader is a class that is responsible for
 ...
 * @since    1.0.0
 */
class Altimea_Custom_Messages_Loader
{
    /**
     * A reference to the collection of actions used throughout the plugin.
     *
     * @var array The array of actions that are defined throughout the plugin.
     */
    protected $actions;
     ...
     *
     * @var array The array of filters that are defined throughout the plugin.
     */
    protected $filters;
