 ...
 */
spl_autoload_register('altimea_custom_messages_namespace_autoload');

/**
 * Dynamically loads the class attempting to be instantiated elsewhere in the
 * plugin by looking at the $class_name parameter being passed as an argument.
 *
 * The argument should be in the form: Altimea_Custom_Messages\Namespace. The
 ...
 */
function altimea_custom_messages_namespace_autoload($class_name) {
    // If the specified $class_name does not include our namespace, duck out.
    if ( false === strpos($class_name, 'Altimea_Custom_Messages')) {
        return;
    }
